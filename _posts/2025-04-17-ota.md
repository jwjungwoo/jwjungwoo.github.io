...
✅ mosquitto broker 를 통해 데이터를 뿌리고 받는 과정이 생각보다 귀엽고 재밌었다.   
✅ 나중에 프로젝트할 때 ota 기술이 많이 쓰일 것 같았다.   
✅ 보안까지 적용하면 좋을 듯하다.
...
![ddd](https://github.com/user-attachments/assets/ddc41b80-fc41-4251-8659-76c951e25abf)   
```python
import os
import hashlib
from cryptography.hazmat.primitives.ciphers import Cipher, algorithms, modes
