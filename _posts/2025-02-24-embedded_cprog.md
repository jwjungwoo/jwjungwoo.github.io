...
int main(void)
{
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
  BSP_LED_On(LED2);  // 이 두 줄 안 써도 됐는데 강사님께서 쓰심.
	BSP_LED_Off(LED3); // on, off로 서로 안 맞춰주면 서로 반대로 토글함.
  /* USER CODE END 2 */
...
<img src="https://github.com/user-attachments/assets/4a8664fe-b69e-4e96-8616-8e3cd875df16" width="300" height="400">   
```c
/* USER CODE BEGIN Header */
/**
  ******************************************************************************
