...
1. 프로세스 상태   
2. 프로그램 카운터: 현재 실행 중인 명령어의 주소를 저장. 이를 통해 다음에 실행될 명령어를 가리킨다.   
...
![KakaoTalk_20250618_072347815](https://github.com/user-attachments/assets/3018ed4a-e6f5-4caf-ada7-f27259650cb5)
